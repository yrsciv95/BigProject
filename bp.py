        ...
        if answer1 == "o":
            ...
            if answer2 == '0':
                ...
                def mesureConv():
                    ...
                    sleep(1)
                    print(
                        "En quel système de mesures voulez-vous faire une conversion ?")
                ...
                def mesureConvM_L():
                    ...
                    sleep(1.5)
                    print(
                        f"{input_long} mi correspond environ à {round(conv, 1)} km")
                    sleep(2)
                    system('pause')
                    print("Accueil...")
                    sleep(1.5)
                ...
                def mesureConvM_V():
                    ...
                    sleep(1.5)
                    print(
                        f"{input_vol} fl oz correspond environ à {round(conv, 1)} L")
                    sleep(2)
                    system('pause')
                    print("Accueil...")
                    sleep(1.5)
                ...
                def mesureConvI_L():
                    ...
                    sleep(1.5)
                    print(
                        f"{input_long} km correspond environ à {round(conv, 1)} mi")
                    sleep(2)
                    system('pause')
                    print("Accueil...")
                    sleep(1.5)
                ...
                def mesureConvI_V():
                    ...
                    sleep(1.5)
                    print(
                        f"{input_vol} L correspond environ à {round(conv, 1)} fl oz")
                    sleep(2)
                    system('pause')
                    print("Accueil...")
                    sleep(1.5)
                ...
                def analyse():
                    ...
                    if test_exist_file == True:
                        if test_file_text[1] in kind:
                            ...
                            print(
                                f"    Nombres de Consonnes: {consonnes_count}")
